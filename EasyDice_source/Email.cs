...
namespace easydice
{
    public class Email
    {
        ...
        {
            string subject = "easydice - Withdraw Alert";
        ...
        {
            string subject = "easydice - Invest Alert";
        ...
        {
            string subject = "easydice - Low Limit Alert!";
        ...
        {
            string subject = "easydice - Bad Streak Alert!";
        ...
        private void sendmail(object Eminfo)
        {
            try
            {
                ...
                message.From = new System.Net.Mail.MailAddress("easydice@seuntjie.com");
