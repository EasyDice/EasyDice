...
namespace easydice
{
    ...
    public partial class ceasydice : Form
    {
        Random r = new Random();
        #region Variables
        ...
        public ceasydice()
        {
            ...
            if (!File.Exists(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\settings"))
            {
                ...
                try
                {
                    ...
                    Directory.CreateDirectory(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2");
                }
                catch
                {
        ...
        {
            save();
            if (File.Exists(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\tempsim"))
            {
                File.Delete(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\tempsim");
            }
        ...
        void save()
        {
            save(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\settings");
            savepersonal();
        }

        void savepersonal()
        {
            using (StreamWriter sw = new StreamWriter(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\settings3"))
            {
        ...
        bool load()
        {
            ...
            return (load(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\settings"));
        }
        ...
        bool load(string File)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (System.IO.File.Exists(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\settings3"))
                    {
                        using (StreamReader sr = new StreamReader(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\settings3"))
                        {
                            while (!sr.EndOfStream)
                            {
                                string[] s = sr.ReadLine().Split('|');
        ...
        {
            using (StreamReader sr = new StreamReader(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\Psettings"))
            {
        ...
        void writesettings()
        {
            using (StreamWriter sw = new StreamWriter(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\Psettings"))
            {
                sw.WriteLine("new");
        ...
        private void ceasydice_Resize(object sender, EventArgs e)
        {
            if (tray)
            {
                if (this.WindowState == FormWindowState.Minimized)
                {
                    ...
                    TrayIcon.BalloonTipText = "easydice is still running";
                    TrayIcon.BalloonTipTitle = "easydice";
        ...
        void menuitemclick(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Are you sure you want to close easydice?", "Close DeciBot", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                {
                    Application.Exit();
                }
            }
            ...
            if (svdExportSim.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        File.Copy(Environment.GetEnvironmentVariable("APPDATA") + "\\easydice2\\tempsim", svdExportSim.FileName);
